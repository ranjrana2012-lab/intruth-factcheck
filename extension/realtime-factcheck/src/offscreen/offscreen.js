...
async function fetchDeepgramToken() {
  const res = await fetch('https://intruth-backend.vercel.app/api/deepgram-token', {
    method: 'POST',
...
chrome.runtime.onMessage.addListener((msg, _sender, sendResponse) => {
  if (msg.type === 'START_CAPTURE') {
    startCapture(msg.streamId, msg.language || 'en-US')
...
async function startCapture(streamId, language = 'en-US') {
